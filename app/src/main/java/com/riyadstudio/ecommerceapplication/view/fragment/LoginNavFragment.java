...
public class LoginNavFragment extends Fragment {
    ...
    private final String TAG = "Login Navigation Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_login_nav, container, false);

        Button continueWithFacebookBtn = view.findViewById(R.id.ContinueWithFacebookTextView);
        MaterialButton continueWithGoogleBtn = view.findViewById(R.id.ContinueWithGoogleTextView);
        Button navigateToSignInWithPassword = view.findViewById(R.id.ContinueWithPasswordTextView);
        ...
        continueWithFacebookBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        navigateToSignInWithPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LoginFragment loginFragment = new LoginFragment();
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.AuthFrameLayout, loginFragment, "findThisFragment")
                        .addToBackStack(null)
                        .commit();
            }
        });
